...
public class Scorebox extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Scorebox(String homeName, String awayName) //constructor///
	{
		...
		try {
			jPic = ImageIO.read(new File("img/Box.jpg"));
		} catch (IOException e) {
		...
		lblTopLine = new JLabel("1ST INNING");
		...
		gbc_lbl_TopLine.ipady = 5;
		gbc_lbl_TopLine.ipadx = 5;
		gbc_lbl_TopLine.insets = new Insets(-67, -120, 5, 5);
		...
		gbc_lblAwayTeam.insets = new Insets(-15, -122, 5, 5);
		...
		gbc_lblAwayScore.insets = new Insets(-15, 9, 5, 5);
		...
		gbc_lbl_awayHits.insets = new Insets(-15, 93, 5, 5); //top, by default
		...
		gbc_lbl_awayErrors.insets = new Insets(-15, 169, 5, 5); //top, by default
		...
		gbc_lblHomeName.insets = new Insets(52, -122, 5, 5);
		...
		gbc_lblHOMEScore.insets = new Insets(52, 9, 5, 5);
		...
		gbc_lbl_homeHits.insets = new Insets(52, 93, 5, 5);
		...
		gbc_lbl_homeErrors.insets = new Insets(52, 169, 5, 5);
